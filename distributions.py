...
class Distribution:
    ...
    def __init__(self, name, mu=None, sigma=None, sigma_multiplier=2, size=None, key=None, output_png=None):
        self._name = name
        self._key = key
        self._mu = mu
        self._sigma = sigma
    ...
    def UpdateParameters(self, name=None, mu=None, sigma=None, size=None, key=None, output_png=None):
        """
