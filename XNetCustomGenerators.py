...
def create_training_validation_sets(class0_dir, class1_dir, labels, cutoff=None):
    ...
    if cutoff is not None:
        ...
        print(f'Using {len(filenames_train_0)} images with cutoff={cutoff}')
...
def create_batch_generators(x_train, x_validation, y_train, y_validation, augmentation):
    ...
    train_generator = BatchGenerator(x_train, y_train, 299,
                                     scale=1. / 255,
                                     width=16,
    ...
    val_generator = BatchGenerator(x_validation, y_validation, 299,
                                   scale=1. / 255,
                                   width=16,
                                   augmentation=augmentation,
                                   jpeg_prob=50,
